...
## AI Summary
Between tags test and 1.4.6 in the component-salesforce-v2 repository, significant changes include refactoring of fetching and retry strategies, fixing bugs related to fetching and UI, adding record checks, updating query parser, enhancing API version handling, improving error messages, adding retry mechanisms, optimizing query performance, adding chunking restrictions, and implementing OAuth login methods. Additionally, improvements were made to metadata handling, test query functionality, and support for Bulk API v2.0, along with various code refactoring and enhancements for better performance and user experience.
...
---
_Generated by [Release Notes Generator](https://github.com/keboola/release-notes-generator) on 2025-02-27 17:10:05_ 