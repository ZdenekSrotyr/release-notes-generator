...
## AI Summary
In the component-salesforce-v2 repository between tags test and 1.4.6, significant changes include: refactoring fetching and retry strategy, fixing bugs related to table columns and fetching, adding retry mechanisms, implementing OAuth login methods, updating API versions, optimizing query performance, adding field filtering and custom bucket support, improving error handling, and enhancing metadata handling. Additionally, improvements were made to logging, code structure, and test query functionality. Overall, these changes aimed to enhance functionality, performance, and user experience in Salesforce data extraction.
...
---
_Generated by [Release Notes Generator](https://github.com/keboola/release-notes-generator) on 2025-02-27 21:40:38_ 