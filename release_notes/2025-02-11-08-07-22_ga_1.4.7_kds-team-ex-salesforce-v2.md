...
## AI Summary
Between tags test and 1.4.7 in the component-salesforce-v2 repository, significant changes include refactoring code for fetching and retry strategies, fixing bugs related to fetching and UI, adding field filtering and API version selection, improving error handling, adding custom bucket support, enhancing performance with chunking, adding type hints, and implementing OAuth login methods. The changes also involve updates to the query parser, schema enhancements, and utilizing Bulk API v2.0 for improved performance and efficiency. Additionally, various bug fixes, code refactoring, and enhancements to metadata handling and logging were made to enhance overall functionality and user experience.
...
- more logging and python 3.13 🐍 ⚡ 




- use bool for incremental 👷‍♂️ 
...
---
_Generated by [Release Notes Generator](https://github.com/keboola/release-notes-generator) on 2025-02-27 17:10:03_ 