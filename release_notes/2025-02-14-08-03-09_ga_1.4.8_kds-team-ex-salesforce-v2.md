...
## AI Summary
Between tags test and 1.4.8 in the component-salesforce-v2 repository, significant changes include refactoring code for fetching and retry strategies, fixing bugs related to fetching and UI, adding retry mechanisms, updating API versions, improving error handling, adding new features like custom bucket support and API version selection, enhancing metadata handling, and implementing Bulk API v2.0. Additionally, improvements were made to logging, error messages, and test query functionality. Overall, these changes aim to enhance functionality, performance, and user experience while addressing various bugs and adding new capabilities.
...
---
_Generated by [Release Notes Generator](https://github.com/keboola/release-notes-generator) on 2025-02-27 21:40:31_ 