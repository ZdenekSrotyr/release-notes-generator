...
## AI Summary
Between tags test and 1.4.8 in the component-salesforce-v2 repository, significant changes include refactoring code for fetching and retry strategies, fixing bugs related to fetching and UI, adding record checks, enhancing error messages, updating API version handling, improving metadata handling, adding chunking for data processing, and implementing OAuth login methods. Additionally, improvements were made to test query functionality, column metadata collection, and Bulk API v2.0 integration. Various bug fixes, code refactoring, and enhancements were implemented to optimize performance and functionality.
...
---
_Generated by [Release Notes Generator](https://github.com/keboola/release-notes-generator) on 2025-02-27 17:10:00_ 